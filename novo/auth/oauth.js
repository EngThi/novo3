...
class CanvaAuth {
  constructor() {
    ...
    this.redirectUri = 'http://127.0.0.1:3001/oauth/redirect'; // Conforme o plano
  ...
  getAuthorizationUrl() {
    ...
    this.codeVerifier = codeVerifier; // Salva para a etapa de troca
  ...
  async exchangeCodeForToken(authCode) {
    if (!this.codeVerifier) {
      throw new Error("Code Verifier não encontrado. O fluxo de autorização precisa ser iniciado primeiro.");
    }
